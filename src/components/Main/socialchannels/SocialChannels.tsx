        ...
        <div className="max-w-5xl mx-auto py-8 px-4 bg-gray-50 min-h-screen">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {channels.map((ch) => (
                    <div
                        key={ch.name}
                        className={`rounded-xl border transition shadow-sm mb-2 ${ch.highlight
                    ...
                    >
                        <div className="flex items-center px-5 pt-4 pb-2">
                            ...
                            <button
                                onClick={() => handleConnectClick(ch.name)}
                        ...
                        >
                            <div className="flex flex-col items-center text-sm">
                                <p className="mb-2">Connect your {ch.name} account to:</p>
                                ...
                                <button
                                    onClick={() => handleConnectClick(ch.name)}
                                    className={`rounded px-4 py-1 text-sm font-medium ${ch.highlight
