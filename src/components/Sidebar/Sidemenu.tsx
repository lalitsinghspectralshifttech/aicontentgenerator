...
const SideMenu: React.FC = () => {
  ...
  const mainMenuItems = [
    ...
    { key: "api-keys", label: "API Keys", path: "/GeminiImageGenerator", icon: <svg className="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24"><path d="M19 3h-4.18c-.41-.33-.91-.5-1.42-.5s-1.01.17-1.42.5H5c-1.11 0-2 .89-2 2v14c0 1.11.89 2 2 2h14c1.11 0 2-.89 2-2V5c0-1.11-.89-2-2-2zM5 21V5h2v2h2V5h6v2h2V5h2v16H5zm2-14h2v2H7V7zm4 0h2v2h-2V7z" /></svg> },
